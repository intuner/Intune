...
if (!(Test-Path $FilePath)) {
    Write-Host "Creating path $($FilePath)."
...
New-ItemProperty -Path $RegKeyPath -Name "DisplayVersion" -Value $Version -PropertyType STRING -Force | Out-Null
